...
data_1 = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220305.csv')
data_2 = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220306.csv')
data_3 = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220307.csv')
data_4 = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220308.csv')
data_5 = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220309.csv')
data_6 = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220310.csv')
data_7 = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220311.csv')
data_8 = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220312.csv')
data_9 = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220313.csv')
data_a = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220314.csv')
data_b = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220315.csv')
data_c = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220316.csv')
data_d = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220317.csv')
data_e = pd.read_csv('./data/지선(5, 6, 7,8)_UTF8/지선(7,8)_UTF8/노선·정류장 지표(노선별 차내 재차인원)_20220318.csv')
