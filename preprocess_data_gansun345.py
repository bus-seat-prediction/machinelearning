...
data_1 = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220401_간선345.csv', encoding='ANSI')
data_2 = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220402_간선345.csv', encoding='ANSI')
data_3 = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220403_간선345.csv', encoding='ANSI')
data_4 = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220404_간선345.csv', encoding='ANSI')
data_5 = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220405_간선345.csv', encoding='ANSI')
data_6 = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220406_간선345.csv', encoding='ANSI')
data_7 = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220407_간선345.csv', encoding='ANSI')
data_8 = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220408_간선345.csv', encoding='ANSI')
data_9 = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220409_간선345.csv', encoding='ANSI')
data_a = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220410_간선345.csv', encoding='ANSI')
data_b = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220411_간선345.csv', encoding='ANSI')
data_c = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220412_간선345.csv', encoding='ANSI')
data_d = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220413_간선345.csv', encoding='ANSI')
data_e = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220414_간선345.csv', encoding='ANSI')
data_f = pd.read_csv('./20220401_20220415/간선34567/노선·정류장 지표(노선별 차내 재차인원)_20220415_간선345.csv', encoding='ANSI')
