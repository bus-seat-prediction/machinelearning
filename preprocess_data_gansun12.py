...
data_1 = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220401.csv', encoding='ANSI')
data_2 = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220402.csv', encoding='ANSI')
data_3 = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220403.csv', encoding='ANSI')
data_4 = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220404.csv', encoding='ANSI')
data_5 = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220405.csv', encoding='ANSI')
data_6 = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220406.csv', encoding='ANSI')
data_7 = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220407.csv', encoding='ANSI')
data_8 = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220408.csv', encoding='ANSI')
data_9 = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220409.csv', encoding='ANSI')
data_a = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220410.csv', encoding='ANSI')
data_b = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220411.csv', encoding='ANSI')
data_c = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220412.csv', encoding='ANSI')
data_d = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220413.csv', encoding='ANSI')
data_e = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220414.csv', encoding='ANSI')
data_f = pd.read_csv('./20220401_20220415/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220415.csv', encoding='ANSI')
