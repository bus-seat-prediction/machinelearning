...
data_1 = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220305.csv', encoding='ANSI')
data_2 = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220306.csv', encoding='ANSI')
data_3 = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220307.csv', encoding='ANSI')
data_4 = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220308.csv', encoding='ANSI')
data_5 = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220309.csv', encoding='ANSI')
data_6 = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220310.csv', encoding='ANSI')
data_7 = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220311.csv', encoding='ANSI')
data_8 = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220312.csv', encoding='ANSI')
data_9 = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220313.csv', encoding='ANSI')
data_a = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220314.csv', encoding='ANSI')
data_b = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220315.csv', encoding='ANSI')
data_c = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220316.csv', encoding='ANSI')
data_d = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220317.csv', encoding='ANSI')
data_e = pd.read_csv('./data/간선12/노선·정류장 지표(노선별 차내 재차인원)_20220318.csv', encoding='ANSI')
